...
//           <p className="mb-5 text-[11px] uppercase tracking-[0.34em] text-[#c6a96b]">The Details</p>

//           <h2 className="font-serif text-[clamp(2.2rem,4vw,4rem)] leading-[0.95] font-light text-white">Finishing touches that define the look.</h2>
//         </motion.div>
...
//           <p className="max-w-2xl text-[15px] leading-8 text-white/50 md:text-[16px]">Accessories bring clarity and character to every outfit. From refined leather goods to sculptural jewelry and timeless eyewear, each piece is designed with intention. Crafted to elevate the everyday, these details complete the wardrobe with quiet confidence.</p>
//         </motion.div>
//       </div>
//     </section>
//   );
